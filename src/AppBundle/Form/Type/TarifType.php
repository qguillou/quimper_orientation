...
class TarifType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('prix', NumberType::class, array('label' => 'Prix', 'attr' => array('class' => 'form-control'), 'label_attr' => array('class' => 'col-sm-4 control-label')))
            ...
            ->add('delete', SubmitType::class, array('label' => 'Supprimer le tarif', 'attr' => array('class' => 'btn btn-danger')));
    }
