...
class UserType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('license', EntityType::class, array('required' => false, 'label' => 'N° de licence FFCO', 'class' => 'AppBundle\Entity\Base', 'choice_label' => 'id', 'required' => false, 'attr' => array('class' => 'form-control'), 'label_attr' => array('class' => 'col-sm-4 control-label')))
